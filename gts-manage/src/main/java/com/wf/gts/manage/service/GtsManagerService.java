...
public interface GtsManagerService {
   ...
   */
  Boolean saveTxTransactionGroup(TransGroup txTransactionGroup);
   ...
   * @return true 成功 false 失败
   */
  Boolean addTxTransaction(String txGroupId, TransItem txTransactionItem);
   ...
   */
  List<TransItem> listByTxGroupId(String txGroupId);
   ...
   * @return
   */
  List<List<TransItem>> listTxTransactionItem();
